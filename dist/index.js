...
function checkSubscription(ctx, channels) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var isSuccess, userId, roles, _i, channels_1, channelId, check, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    channelId = channels_1[_i];
                    _c.label = 2;
                case 2:
                    _c.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, ctx.telegram.getChatMember(channelId, userId)];
                case 3:
                    check = _c.sent();
